...
class UpdateOrganizationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'twitter_followers' => ['nullable', 'max:191'],
            'insta_followers' => ['nullable', 'max:191'],
            'activity_score' => ['nullable', 'max:191'],
            'popularity_score' => ['nullable', 'max:191'],
            'overall_score' => ['nullable', 'max:191'],
            'fb_likes' => ['nullable', 'max:191'],
