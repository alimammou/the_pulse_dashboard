...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        */
        ...
        Blueprint::macro('stamps', function () {
            $this->timestamps();
            $this->softDeletes();
            $this->userstamps();
            $this->softUserstamps();
        ...
        EloquentDataTable::macro('filterStatus', function (string $column) {
            return $this->filterColumn($column, fn ($query, $keyword) => $query->where($column, '=', $keyword));
        });
    }
}
