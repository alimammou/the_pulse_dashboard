...
//if (! function_exists('active_class_for_route')) {
//    function active_class_for_pattern($pattern, $activeClass = 'active', $inactiveClass = '')
//    {
//        return Route::is($pattern) ? $activeClass : $inactiveClass;
//    }
//}
