...
use App\Http\Controllers\Backend\Auth\User\UserTableController;
...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        // For DataTables
        Route::post('user/get', [UserTableController::class, '__invoke'])->name('user.get');
        ...
        Route::get('user/create-cso', [UserController::class, 'createCso'])->name('user.create-cso');
        Route::post('user', [UserController::class, 'store'])->name('user.store');
        Route::post('user-cso', [UserController::class, 'storeCso'])->name('user.store-cso');
        ...
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            Route::patch('/approve', [UserController::class, 'approve'])->name('user.approve');
            ...
            // Status
            Route::get('mark/{status}', [UserStatusController::class, 'mark'])->name('user.mark');
