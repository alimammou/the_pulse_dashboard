<div class="card-body">
    ...
    <div class="">
        <div class="col">
            ...
            ></x-admin.fields.text-field>
            <x-admin.fields.neutrality-field
                name="opinion_neutrality"
                placeholder="Opinion on Neutrality"

            ></x-admin.fields.neutrality-field>
            <x-admin.fields.weapons-field
            ...
            ></x-admin.fields.text-field>
            <x-admin.fields.file-field
                name="logo"
                value="{{isset($organization) ? $organization->logo_url ?? null : null}}"
                placeholder="Logo"
            ></x-admin.fields.file-field>
            <x-admin.fields.file-field
                name="economic_plan_upload"
                value="{{isset($organization) ? $organization->economic_plan_url ?? null : null}}"
                placeholder="economic plan file"
            ></x-admin.fields.file-field>
            <x-admin.fields.text-field
                name="economic_plan_title"
                placeholder="economic plan title"
            ></x-admin.fields.text-field>
