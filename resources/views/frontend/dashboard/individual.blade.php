            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">General Information Individual</span>
                    </div>
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-xl-12 row">
                    ...
                    <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body" style="min-height: 750px!important;">
                            <div class="row">
                                <div class="col-xl-8">
                            ...
                            <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-no-border">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="//facebook.com/{{$organization->fb_username}}" target="_blank">{{$organization->fb_username}}</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Twitter
                                                </td>
                                                <td><a href="//twitter.com/{{$organization->twitter_username}}" target="_blank">{{$organization->twitter_username}}</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Instagram
                                                </td>
                                                <td><a href="//instagram.com/{{$organization->insta_username}}" target="_blank">{{$organization->insta_username}}</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>The pulse region
                                                </td>
                                                <td>{{$organization->the_pulse_region}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Website
                                ...
                                <div class="col-xl-4">
                                    <img class="card-img img-fluid" src="{{$organization->logo_url?? asset("images/placeholder.png")}}" alt="">
                                    <div style="  position: absolute;bottom: 0px;">
                                        <a class="arrow-nav" @if($organization->id>1)href="{{Route('frontend.individual',\App\Models\Organization\Organization::where('id', '<',$organization->id)->orderBy('id','desc')->value('slug'))}}" @endif>
                                            <i class="fas fa-arrow-alt-circle-left fa-5x" style=" display: inline-block;padding-right: 20px"></i>
                                        </a>
                                        <a class="arrow-nav" @if($organization->id<\App\Models\Organization\Organization::latest('id')->first()->id) href="{{Route('frontend.individual',\App\Models\Organization\Organization::where('id', '>',$organization->id)->orderBy('id','asc')->value('slug'))}}" @endif>
                                            <i class="fas fa-arrow-alt-circle-right fa-5x" style=" display: inline-block;right: 0px"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-xl-12 ">
                                    <div>
                                        <h5 style="font-weight: bold;font-size: 14px">Mission</h5>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-no-border">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$organization->key_figure_eng}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>E mail
                    ...
                    <div style="height: 98%;" class="card">
                        <div class="card-body" style="min-height: 750px!important;">
                            <div class="row">
                                <div class="col-xl-12">
                                    <h5 class="card-title text-center">Location per district</h5>
                                </div>
                                <div class="col-xl-12 row" style="justify-content: center; margin-top: 50px ">
                                    <div style="width: 50%;height: 500px;" class="card-img img-fluid" src="{{asset("images/map.svg")}}" alt="">
                                    <!-- Generator: Adobe Illustrator 22.1.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                                        <svg version="1.1"
                                             ...
                                             style="enable-background:new 0 0 424 599;height: 100%;
    width: 100%; transform: scale(1.5);" xml:space="preserve">
<style type="text/css">
    /*.st0{fill-opacity:0.1006;stroke:#000000;stroke-width:3;}*/
    /*.st1{fill:#FFFFFF;fill-opacity:0.3408;stroke:#000000;stroke-width:2;}*/
    /*.st2{fill:#FFFFFF;fill-opacity:0.2793;stroke:#000000;stroke-width:2;}*/
    /*.st3{fill:none;stroke:#000000;}*/
    /*.st4{fill:#F9F9F9;fill-opacity:0.2179;stroke:#000000;stroke-width:2;}*/
    /*.st5{fill:#FFFFFF;fill-opacity:0.2067;stroke:#000000;}*/
    /*.st6{fill:#FCFCFC;fill-opacity:0.1955;stroke:#000000;stroke-width:2;}*/
    /*.st7{fill:#F9F9F9;fill-opacity:0.3408;stroke:#000000;stroke-width:2;}*/
    /*.st8{fill:#FFFFFF;fill-opacity:0.2514;stroke:#000000;stroke-width:2;}*/
    /*.st9{fill:#FCFCFC;fill-opacity:0.6425;stroke:#000000;}*/
    /*.st0{fill:#FFFFFF;fill-opacity:0.1006;stroke:#000000;stroke-width:3;}*/
    /*.st1{fill:#FFFFFF;fill-opacity:0.3408;stroke:#000000;stroke-width:2;}*/
    /*.st2{fill:#FFFFFF;fill-opacity:0.2793;stroke:#000000;stroke-width:2;}*/
    /*.st3{fill:#FFFFFF;fill-opacity:0.2793;stroke:#000000;stroke-width:2;}*/
    /*.st4{fill:#FFFFFF;fill-opacity:0.2793;stroke:#000000;stroke-width:2;}*/
    /*.st5{fill:#FFFFFF;fill-opacity:0.2067;stroke:#000000;}*/
    /*.st6{fill:#FFFFFF;fill-opacity:0.2793;stroke:#000000;stroke-width:2;}*/
    /*.st7{fill:#FFFFFF;fill-opacity:0.2793;stroke:#000000;stroke-width:2;}*/
    /*.st8{fill:#FFFFFF;fill-opacity:0.2514;stroke:#000000;stroke-width:2;}*/
    /*.st9{fill:#FCFCFC;fill-opacity:0.6425;stroke:#000000;}*/
    svg path {
        fill:black;
    ...
    svg path.region{
        ...
        stroke-width:2;
                                            ...
                                            <g id="layer1" transform="translate(-205.14285,-190.00502)" inkscape:groupmode="layer" inkscape:label="Capa 1">
		...
		l5.3-2.3h4l5.6-2l3.3-2.3l3,2.8l5.1-1l2.8,4.8l-3.3,6.8l3.8,3.5l1.2,4.8l-2.3,7.6l4.1,1.5L356.3,617.9z"/>
                                                <path id="zgarta"  class="region" d="M459.7,331.6l-2.4-13.7h-0.1l-3.5,3l1.3,2l1.8,3l-1,2.5h-2.3l-2-1.5l-2.2,1.5l1,3l-1.5-0.5
		...
		l2.5,1l4.2-2.2l0.8-2.5l-1.8-0.5l2.5-2.8l-1.8-1.5l2.5-1.5l4.2-0.8l1.8-5h2.8L459.7,331.6z"/>
                                                ...
                                                <path id="zgarta" class="region" d="M451.9,308.4l-1.5,1.8h-3l-1,3.5l-8.6,9.1l-12.9,3h-0.5l-5.8,0.2l-1.5-1.8v3l-1,0.2l-2.3-2.3
		...
		s0.5-0.4,0.7-0.7c0.1-0.2,0.2-0.6,0.2-1.1v-0.3H457.4z"/>
                                                ...
                                                <path id="bent jbail"  class="region" d="M321.7,732.9l-7-3.8l1.5-6.8l1.2-2.5l-1.2-2l0.8-5.6l-0.2-6.8l-2.3,1l-5.6-0.2l-3-6.6l-2.8-2.8
		...
		l-0.7,3.3l0.7,1.2l4.1,0.2l2,5.3l5.9,7.5l4.6,0.7l0.9,1.1l1.6-0.2l1.4-1.4l12.3-1.8l4.7-6.8l9.5-0.5l4.8,1.1L321.7,732.9z"/>
                                                <path id="marjaayoun"  class="region" d="M334.2,660.9l-1,6.2l-2.5,11.1l-2.2-1l-3.8-1.5h-5.3l-1.3-2.3l-10.1-0.2l-1.5,0.7l0.5,0.5
...
{{--		l0.2-6.3l4.6-7.8l-0.3-2l-2.5-0.5l-1-2l3.3-5.6l-3.8-3.8l1.3-2.8l4.8-4.3l-1.5-1.5l3.3-4.8L331.9,612.5z"/>--}}
		...
		L472.1,525.4z"/>
                                                <path id="batrun"  class="region" d="M470.8,404.6l-6.6-4l-2,2h-3.5l-3.8-1l-4.3,1l-1.5-1.2l-3.8-1.2l-3.5,0.2l-3,1.2l-1.8-0.2
		...
		l2-0.5l11.6,4.3l4.8,3l1,5.6l5.8-11.4l-6.6-1.2l9.1-10.9L470.8,404.6z"/>
                                                <path id="tripoli"  class="region" d="M427.3,345.6l0.1-0.1l1.3-2.8l-3.8-3.5l-1-3.3l2.5-3l0.2-4.2l-2.3-2.8l-5.8,0.2l-1.5-1.8v3
		l-1,0.2l-2.3-2.3l-1,2.3l1,1.8v4.8l2.3,1l-1,5.6c-4.9,4.4-9.7,6.5-13.7,7.5l2.8,2.8l6.8-4.3l5.9-4.5l2.1-4.5l4.2,8.5L427.3,345.6z"
                                                />
                                                <path id="bcharre"  class="region" d="M495.4,375.3l-2.6-1.6l-3.2,0.8l-0.2,3.8l-2.8,2.2l-5.8,0.8l-6,1.8l-2.2-2l-8.5,0.5l-3.5,3.2
		...
		l1.5,1.2l4.3-1l3.8,1h3.5l2-2l6.6,4l2.8-1.7l6.1-7.1l0.5-1.5l7.3-9.3l2.3-0.5l4.5-4.3L495.4,375.3z"/>
                                                <path id="minieh - dinnieh"  class="region" d="M533.8,322l-7.9,6.9l-3.2-0.5l0.8,6.8l0.2,4l-2.5,1l-1.5-1.2l-1.2,1.2l-4.2-0.5l-9,2.5l-2-2.2
		...
		l1.8-2.3l2-7.3l1.8-3.5l0.8-2.8l4-4.3L533.8,322z"/>
                                                <path id="hermel"   class="region" d="M494.5,379l0.8,1.1h2.8l1.8,2.1l-1.4,3.5l6,3.2l7.4,2.1h6l4.2,2.8l-2.1,1.8l5.7,1.4l9.2,3.2
...
{{--		l-8.6,9.1l-12.9,3h-0.5l2.3,2.8L426.4,332.4z"/>--}}
                                                <path id="akkar"   class="region" d="M549.1,257.2c-10.9,2.1-7.9,10.7-7.9,10.7l-2,5.2c-7.1,7-14.1,0.7-14.1,0.7l-2.8,2.5l-3.4,0.7
		...
		L549.1,257.2z"/>
                                                <path id="koura"  class="region" d="M409.7,390.1l2.7-1.8l-0.8-2.5l3.8-1.5l0.8-2h3.5l2.5,2.5l2-0.8l2.2-4l1-3.3l-2.2-5.5l-1.2-8.8
		...
		c-0.3-0.3-0.5-0.5-0.8-0.7l-0.2,0.4l1.3,4.2l2.5,0.2l2.8,3.3l-1.2,1.8l1.5,2.2l7,1.8l7.8,4.8L409.7,390.1z"/>
                                                <path id="kesrouan"  class="region" d="M378.1,439.2l-7.4,3.2l-0.4,2.1l-5.4,3l-1.7,1.8c-5.3,10.1,2.5,10.1,2.5,10.1l1,5.6l-3,3h-4
		...
		l-2.5,3.9l-1.8-1.8h-2.5l-6,1.4l-5,0.3l0.4-2.5l-2.5-2.5l3.2-3.9l0.7-2.5h-5l-2.1,1.4l-9.2,0.4L382,439h-3.9V439.2z"/>
                                                <path id="baabda"  class="region" d="M408.2,499.8l-7.1,0.7l-6.7,2.8l-6.4-2.8l-7.1-0.3l-7.5,0.3l-4.9,1.8l-5.7,1.8l-3.5,1.4
		...
		l1.9-0.1l-0.1-0.6l2.2,0.4l3.6-0.2l0.8-3l3.3-2l-1.2-1.3l-0.8-2.2l2-1.3l6.1-7.6l4-2.6L408.2,499.8z"/>
                                                <path id="aley"  class="region" d="M395.9,523.1l-1.9,0.1l-5.7,3.9l-3.6-0.4l-3.5-3.5l-3.9,1.1l-6-0.7l-3.5-2.8l-2.1,1.8l-6-1.1
		...
		l2.5-2.1l2.8-3.2h2.5l3.9,2.8l11.9,3.2l3-2l3.8-3.3l2.3-2.8v-3.8l2-2.8v-2l-1.8,0.8l-6.1-1.3l-2.3-3.5L395.9,523.1z"/>
                                                <path id="el metn"  class="region" d="M426.7,481.1l-12.4-5.7l-1.4-2.8l-4.2-0.7l-0.3,2.1l-8.9,1.4l0.4,2.8l-2.8,1.4l-4.2-3.9l-6,2.2
		...
		l2.5-1.3l1.2-2l-1.8-1.5l3.8-3.3l2.5,0.8l4.5-1.2l2-3.5l-1-2.3l-3.3-0.2L426.7,481.1z"/>
                                                <path id="chouf"   class="region" d="M395.3,545.5l-11.9-3.2l-3.9-2.8H377l-2.8,3.2l-2.5,2.1l-5-0.4l-4.6-3.5l-4.6,3.5l-4.2,0.7
		...
		l2.5-3l1.8-3.5L395.3,545.5z"/>
                                                <path id="zahle"  class="region" d="M472.1,525.4l8.3-15.6l-1.4-1.1l-2.5,0.7l-1.4-2.8h-1.8l-3.9,1.4l-4.6-2.1l0.7-2.5l-4.2,0.7
		l-1.8,3.5l-4.2,2.1l-4.2-6.4l0.7-3.9l-1.4-0.3l-2.1-3.6l-3.9-3.2l-3.2,1.1l-4.9-1.4l-1.8-4.6l-3.1-1l0.3,0.8l-2,3.5l-4.5,1.2
		l-2.5-0.8l-3.8,3.3l1.8,1.5l-1.2,2l-2.5,1.3l0.5,2.5l-5.6,3.5l-6.1,7.6l-2,1.3l0.8,2.2l1.2,1.3l-3.3,2l-1,3.6h-1.8l-3.8-0.8
		...
		l7-2.5l5.9-6.8h4.5l6-8.6l-0.2-0.3l1.7-3.1l0.8-1.8L472.1,525.4z"/>
                                                <path id="rachaya"  class="region" d="M438.9,561.7l-5.2,3.3v5.7l-3.9,3.2l-8.2,3.2l-2.5-2.1l-3.5,2.5l-1.4,4.6l-6,3.9l0.7,1.8h-3.2
		...
		L438.9,561.7z"/>
                                                <path id="bekka"  class="region" d="M426.3,534.6l-7.4,3.5l-0.3,3.6l-5.7,4.2l-3.2,9.9l-2.5-9.6l-0.4-5.3l-2.1,1.4l-3.7-1.1
		...
		l8.2-3.2l3.9-3.2V565l5.2-3.3l-4.5-4.5l-3.5-0.4l-4.6,1.8l-4.6-5l3.2-5.3l2.8-1.1l2.5-1.8l-0.7-3.9l-1.4-3.2l0.7-2.8L426.3,534.6z"
                                                />
                                                <path id="nabatiye"  class="region" d="M331.9,612.5l-2,1.3l-1.2,2.8h-2.5l-1.5,1.2l-3.8,2.3l-1,1.2l-1.8,1.2l-2.5-5h-2.2l0.5,3l-1,2
		l-4.8-3.8h-1.5l-1.8,2.8l-3.3-0.5l-1.8,1.5l3.6,1.5l2,2.5l-2.3,2.8l-5.3-1.8l-1,2.5l-1.5,6.1l0.2,2.8l3.5,3.5l0.8,1.5l-3,0.8
		l-0.2,0.2l-5,1.2l-1.3,3.3l1.3,2.3l-2.5,0.8l-4.6-4.5l-0.8-4.8l-1.8,1.3h-2l-1.8,2l-4.5,3.5l3.5-1v3.8l-6.1,1c0,0,3.3,0.7,4.6,1
		c1.3,0.3,2.3,0.5,3.3,0.5s2.5,0.2,2.5,0.2l1.8,2.5c0,0,1,0,2.5,0c0.8,0,1.4,0.3,1.9,0.6s0.8,0.6,0.8,0.6l-1,3.5l-1.5,2l-2.5,2
		l-0.5,2.3c0,0,1.8,1.5,2.8,2s1.5,0.5,2.8,0.8c0.6,0.1,1,0.5,1.2,0.8s0.3,0.5,0.3,0.5l2.5,0.2l1.8-2l1.8,1.8l2,1.8l2-1l1.8-1.5
		...
		l-0.3-2l-2.5-0.5l-1-2l3.3-5.6l-3.8-3.8l1.3-2.8l4.8-4.3l-1.5-1.5l3.3-4.8L331.9,612.5z"/>
                                                <path id="hasbaya"  class="region" d="M350.4,646.5l3.5,2.1l2.8,4l1.2,3.3l1,3.5l-1.8,2.8l-1.5,4.3l1.3,1.5v4.6l1.5,1.2l-0.5,2.3
		...
		l-1.5,0.8l-0.2,4.3l-3.3,3.8v1.8l-3.3,3l-3-3.8l-6.8,4.3l-2.8,1v3.5L350.4,646.5z"/>
                                                <path id="sur"  class="region" d="M283,667.8l-11.8,0.2l-6.8-0.7l-3.6-1.8l-2.5-3.2l-1.2,0.1l-0.1,0.2l-7,11.6l-0.7,4.8l-2.8,2.5
		...
		l-1.8,2l-2.5-0.2c0,0-0.1-0.2-0.3-0.5c-0.2-0.3-0.6-0.6-1.2-0.8c-1.3-0.3-1.8-0.2-2.8-0.8s-2.8-2-2.8-2L283,667.8z"/>
                                                <path id="sidon"  class="region" d="M324.6,617.7l-0.2-4.8l2.5-1.8l-2.1-1.1l-0.4-2.5l-5.3-1.4l-0.7,5L312,610l-1.8,2.9l-5.3-5.4
		...
		l1.8-1.2l1-1.2L324.6,617.7L324.6,617.7z"/>
                                                ...
                                                <path id="beirut"  class="region" d="M323.6,502.7l0.2,0.2l5.3,0.5l1,2l4.3-4.8l2.5-1.5l1.2-6.7L335,492l-1.8,1.3l-1.8-1.3l-1-1.5
...
{{--		z"/>--}}
                                                ...
                                                <path id="jezzine"  class="region" d="M324.6,617.7l1.5-1.2h2.5l1.2-2.8l2-1.3l5.8,2l-3.3,4.8l1.5,1.5L331,625l-1.3,2.8l3.8,3.8
		...
		l5.3,5.4l1.8-2.9l6.4,1.1l0.7-5l5.3,1.4l0.4,2.5l2.1,1.1l-2.5,1.8L324.6,617.7z"/>
                                                ...
                                                <path id="baalbek" class="region" d="M494.5,379l-0.2,1.2l-4.5,4.3l-2.3,0.5l-7.3,9.3l-0.5,1.5L476,400l-2.7,3.7l-3.2,1l-8.6,10.8
		...
		L494.5,379z"/>
                                                ...
                                                <path id="jbail"  class="region" d="M364.9,447.6l5.4-3l0.4-2.1l7.4-3.2h4.2l6.7,2.5l9.2-0.4l2.1-1.4h5l-0.7,2.5l-3.2,3.9l2.5,2.5
	...
	c-0.4,0.1-0.7,0.1-0.9,0.2s-0.3,0.2-0.4,0.3s-0.1,0.3-0.1,0.5c0,0.3,0.1,0.5,0.3,0.7s0.5,0.3,0.9,0.3s0.8-0.1,1.1-0.3"/>
		...
		s-0.1,0.3-0.1,0.5c0,0.3,0.1,0.5,0.3,0.7s0.5,0.3,0.9,0.3s0.8-0.1,1.1-0.3s0.5-0.4,0.7-0.7c0.1-0.2,0.2-0.6,0.2-1.1v-0.3H403z"/>
                                                <g id="g18985" transform="translate(208.48296,57.132348)">
                                                </g>
                                                <g id="g18998" transform="translate(234.54333,92.213615)">
                                                </g>
