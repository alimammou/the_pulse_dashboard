...
var XonBoard = {}; // common variable used in all the files of the backend
            ...
            dtAnchorToForm: function ($parent) {
                ...
                $('[data-method]', $parent).append(function () {
                    if (!$(this).find('form').length > 0) {
                        ...
                        {
                            return "\n<form action='" + $(this).attr('href') + "' method='POST' name='approve_item' style='display:none'>\n" +
